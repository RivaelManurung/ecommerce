  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day: cn(
          "h-9 w-9 p-0 font-normal aria-selected:opacity-100 rounded-md hover:bg-gray-100 hover:text-gray-900 focus:bg-gray-100 focus:text-gray-900 transition-colors"
        ),
