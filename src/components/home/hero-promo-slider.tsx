...
const slides: Slide[] = [
  ...
  },
  {
    ...
    primaryHref: "/category/lips",
    secondaryLabel: "Cari Warnamu",
    secondaryHref: "/search?q=lip",
  ...
  },
  {
    ...
    primaryHref: "/category/makeup",
    secondaryLabel: "Pelajari Rutinitas",
    secondaryHref: "/category/skincare",
