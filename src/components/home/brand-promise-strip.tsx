...
export function BrandPromiseStrip() {
  return (
    <section className="container-page py-4">
      <Reveal>
        <div className="grid gap-3 rounded-2xl border border-[#EEE7E2] bg-white/80 p-4 shadow-[0_14px_45px_rgba(73,45,38,0.05)] backdrop-blur md:grid-cols-4">
          {promises.map(({ title, copy, Icon }) => (
            <div key={title} className="flex items-center gap-3 border-[#EEE7E2] md:border-r md:last:border-0">
