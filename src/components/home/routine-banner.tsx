        ...
        <div className="relative overflow-hidden rounded-3xl border border-[#EEE7E2] bg-[#DDE8D5] p-7 md:p-10">
          ...
          <div className="relative grid items-center gap-8 md:grid-cols-[1fr_420px]">
            <div>
              ...
              <Link href="/shop" className="mt-7 inline-flex min-h-11 items-center gap-2 rounded-md bg-[#C95F72] px-5 text-sm font-bold uppercase tracking-[0.12em] text-white transition hover:bg-[#A9445A]">
